...
<div class="content-wrapper">
               ...
               <form action="#" method="post" onsubmit="return validateForm()">
                 <div class="row">
                   <div class="col">
                     ...
                     <input type="text" class="form-control" id="thaiKy" placeholder="Nhập thai kỳ mà trẻ sinh ra" name="thaiKy"></br>
                     <td>Tình trạng</td>
 ...
 <?php
  ...
  if (isset($_REQUEST["btnsubmit"])) {
    ...
    // $noiDungKetQua = $_REQUEST['noiDungKetQua'];
    $p = new cHoSoTreEm();
    $table = $p->add_TE($hoTen, $ngaySinh, $thaiKy, $tinhTrang, '');
    if ($table == 1) {
